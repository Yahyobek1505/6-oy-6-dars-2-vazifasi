...
const App = () => {
  ...
  return (
    <div className="container max-w-[1100px]">
      ...
      <nav className="flex justify-center gap-5 navbar bg-base-100 mt-5 bg-purple-500  rounded-lg flex-wrap">
        <button
          id="priceSortBtnLowtoHigh"
          className= " text-white bg-blue-500 btn btn-success"
      ...
      <div
        id="pruducts-wrapper"
        className="my-6 border-2 border-orange-600 rounded-lg p-6 flex gap-10 flex-wrap justify-center"
      >
